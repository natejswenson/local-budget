...
- **Displayed/labeled text** — a dollar or percentage figure the user actually
  ...
  "| 5 | Groceries | $111.11 | 15 |" — the leading cell is the tool's own
...
Groceries row above, or Recipe 3's Shopping/Sports percentages below — are
...
2. **Category breakdown** — the horizontal bar chart already built this
   ...
   "| 5 | Groceries | $111.11 | 15 |" — Row, Category, Spent, #, since the
...
3. **Budget vs. actual** — one **meter** per category that has a budget set
   ...
   Sports at 78% for 2026-06) still drives the fill amount and the
