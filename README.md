...
A **local-first, agent-first** the bank spending agent. Your data stays in one
...
1. **Import.** Drop a the bank `.qfx`/`.ofx`/`.csv` export in your inbox and
