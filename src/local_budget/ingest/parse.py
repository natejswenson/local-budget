...
def _parse_csv(path: Path) -> list[ParsedAccount]:
    """CSV parser handling BOTH the bank's HEADERLESS export and headered CSVs.

    the bank "Download Account Activity" CSV has NO header row and 5 columns:
    ...
    pa = ParsedAccount(bankid="csv", acctid="csv", acct_type=None, institution="the bank")
